...
export function CertificationsSection({ playClick: _playClick }) {
  return (
    <section id="certifications" aria-label="Certifications and Academic Credentials" className="relative py-20 sm:py-28 bg-[#09090b] overflow-hidden border-t border-zinc-900">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-6 items-stretch">
          {/* Featured Spotlight: NPTEL Elite Gold Java with 3D Tilt */}
          <motion.div
          ...
          >
            <TiltCard maxTilt={3.5} className="h-full rounded-3xl">
              <div className="p-6 sm:p-8 rounded-3xl bg-gradient-to-br from-amber-500/10 via-zinc-900/90 to-zinc-950 border border-amber-400/40 relative overflow-hidden shadow-2xl flex flex-col justify-between h-full">
          ...
          {/* Secondary Credential: Hindi Praveen Poorvardh with 3D Tilt */}
          <motion.div
            initial={{ opacity: 0, y: 20 }}
            whileInView={{ opacity: 1, y: 0 }}
            viewport={{ once: true }}
          ...
          >
            <TiltCard maxTilt={4} className="h-full rounded-3xl">
              <div className="p-6 sm:p-8 rounded-3xl bg-zinc-950/80 border border-zinc-800/80 flex flex-col justify-between h-full shadow-lg">
                <div>
